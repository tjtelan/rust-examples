...
impl ::protobuf::Message for OrderID {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                    "id",
                    |m: &OrderID| { &m.id },
                    |m: &mut OrderID| { &mut m.id },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<OrderID>(
                    "OrderID",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static OrderID {
        static mut instance: ::protobuf::lazy::Lazy<OrderID> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const OrderID,
        };
        unsafe {
...
pub struct OrderRecord {
    // message fields
    pub id: ::protobuf::SingularPtrField<OrderID>,
    pub order: ::protobuf::SingularPtrField<OrderForm>,
...
impl OrderRecord {
    ...
    // Param is passed by value, moved
    pub fn set_id(&mut self, v: OrderID) {
        self.id = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_id(&mut self) -> &mut OrderID {
        if self.id.is_none() {
            self.id.set_default();
        }
    ...
    // Take field
    pub fn take_id(&mut self) -> OrderID {
        self.id.take().unwrap_or_else(|| OrderID::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_order(&mut self, v: OrderForm) {
        self.order = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_order(&mut self) -> &mut OrderForm {
    ...
    // Take field
    pub fn take_order(&mut self) -> OrderForm {
        self.order.take().unwrap_or_else(|| OrderForm::new())
    }

    pub fn get_order(&self) -> &OrderForm {
        self.order.as_ref().unwrap_or_else(|| OrderForm::default_instance())
    }
...
impl ::protobuf::Message for OrderRecord {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<OrderID>>(
                    "id",
                    |m: &OrderRecord| { &m.id },
                    |m: &mut OrderRecord| { &mut m.id },
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<OrderForm>>(
                    "order",
                    |m: &OrderRecord| { &m.order },
                    |m: &mut OrderRecord| { &mut m.order },
                ));
...
pub struct OrderRecordList {
    // message fields
    pub order: ::protobuf::SingularPtrField<OrderRecord>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl OrderRecordList {
    ...
    // Param is passed by value, moved
    pub fn set_order(&mut self, v: OrderRecord) {
        self.order = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_order(&mut self) -> &mut OrderRecord {
        if self.order.is_none() {
            self.order.set_default();
        }
        self.order.as_mut().unwrap()
    ...
    // Take field
    pub fn take_order(&mut self) -> OrderRecord {
        self.order.take().unwrap_or_else(|| OrderRecord::new())
    }

    pub fn get_order(&self) -> &OrderRecord {
        self.order.as_ref().unwrap_or_else(|| OrderRecord::default_instance())
    }
}
...
impl ::protobuf::Message for OrderRecordList {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                let mut fields = ::std::vec::Vec::new();
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<OrderRecord>>(
                    "order",
